...
class PaymentMethod(SQLModel, table=True):
    """
    Referencia tokenizada de un instrumento de pago.
    ...
    __table_args__ = (
        UniqueConstraint("gateway", "external_token", name="pm_external_gateway_key"),
    ...
    exp_month: Optional[int] = Field(default=None, sa_column=Column(SmallInteger, nullable=True))
    exp_year: Optional[int] = Field(default=None, sa_column=Column(SmallInteger, nullable=True))
    fingerprint: Optional[str] = Field(default=None, sa_column=Column(Text, nullable=True))
