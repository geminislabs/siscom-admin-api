...
# `InternalTokenRequest` e `InternalTokenResponse` vivian aqui, y se borraron
# junto con `POST /auth/internal` el 22/09/2026. Ver la nota en
# `app/api/v1/endpoints/auth.py` y `docs/security/plano-de-control-abierto.md`.
